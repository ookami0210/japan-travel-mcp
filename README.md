...
> 13,394 tourist spots × 18 languages, about 20,000 accommodations, 690
...
Then ask the model anything like "What's special about Tottori, in Russian?" — it gets an 18-language tourism description generated from factual information referenced to official Japanese public sources.
...
| 18-language tourism descriptions (200-300 chars) |     ✅ 13K spots     |      sparse      |  name only     |  EN + a few    |
...
| **`get_description`** | **SIGNATURE TOOL.** 200-300 character tourism descriptions in **18 languages** for 13,000+ spots, generated for global tourist consumption |
...
This MCP exposes 18-language tourism descriptions — English, Japanese, Chinese (Simplified and Traditional), Korean,
...
Sonnet 4.6 from factual information extracted and structured by the project,
Wikidata-derived structured data, and a project-wide canonical glossary
(e.g. 神社 → Shrine, 寺 → Temple, modified Hepburn romanisation for place-names)
for consistency across the 18 languages. These descriptions are not source-page
...
Layer 5: 18-language translation layer     — Wikipedia sitelinks + Sonnet 4.6 batch
...
without depending on freeform descriptions alone. Source-page prose,
photos, and editorial descriptions are not redistributed in the dataset.
See
...
All 690 designation records are translated to the same 18 languages by an
...
```
data/translations/    # 18-language names + 200-300 char descriptions
...
The project ships **18 languages** as a first-class feature, not an afterthought.

**Coverage matrix (2026-04-27):**

| Layer | What | Coverage | Source |
|:---|:---|:---|:---|
| Attraction names | Canonical entity name in 18 languages | 13,961 entities × 18 langs (251,267 pairs) | Wikipedia sitelinks + Sonnet 4.6 batch |
| Attraction descriptions | 200-300 char tourism description in 18 languages | 13,394 entities × 18 langs (241,092 descriptions) | Sonnet 4.6 batch, glossary-grounded |
| Wikipedia-anchored names (raw) | Sitelinks-only subset | 41,404 entities, sparse cross-language | Wikidata SPARQL sitelinks |
| Designation-source translations | Names + descriptions for every officially-designated record | **690 records × 18 langs (100% coverage)** | Sonnet 4.6 batch from official designation records and source references |
