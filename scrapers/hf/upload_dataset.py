#!/usr/bin/env python3
"""
Upload data/ to the kjsunada/japan-travel-mcp-data dataset on Hugging Face.
...
Env (loaded from .env):
    ...
    HF_DATASET_REPO   (default: kjsunada/japan-travel-mcp-data)
"""
...
REPO_DEFAULT = "kjsunada/japan-travel-mcp-data"
...
#
# Boundary policy (decided 2026-04-27 with KJ):
